                              ...
                              foreach($bookingViewModelList as $booking)
                              {
                                   ?>
                                        <tr>
                                             ...
                                             <td><a class="btn btn-dark ml-auto" href="<?php echo FRONT_ROOT ?>Review/ShowReviewForm?idbooking=<?php echo $booking->GetIdBooking() ?>&idKeeper=<?php echo $booking->GetIdKeeper() ?>">Calificar</a>
                                        </tr>
                                   <?php
                              }
                         ?>
